...
class RealESRGAN_TRT_CUDA(VideoTransformer):
    def __init__(self, onnx_model_path="models/RealESRGANv2/RealESRGANv2-animevideo-xsx2.onnx", cache_dir="trt_cache", tile_width=620, tile_height=360, tile_pad=64, scale=2):
